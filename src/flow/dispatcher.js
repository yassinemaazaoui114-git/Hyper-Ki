...
import {stepTitle,stepSelect,stepMSettings,stepSettings,stepControls,stepRecords} from './screens.js';
...
import {drawRecords} from '../screens/records.js';
...
export function step(){
  ...
  switch(game.state){
    ...
    case 'records':stepRecords();break;
